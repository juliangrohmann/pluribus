...
pokerstars = SiteConfig(
  ...
  is_spade=lambda rgb: is_exact_rgb(rgb, (108, 109, 109), 10),
  is_club=lambda rgb: is_exact_rgb(rgb, (112, 168, 76), 10),
  is_heart=lambda rgb: is_exact_rgb(rgb, (157, 70, 70), 10),
...
pokerstars_6p = PokerConfig(
  ...
  hole_cards_suits=(((0.5245, 0.7355), (0.5952, 0.7355)),
                    ((0.0888, 0.4930), (0.1537, 0.4930)),
                    ((0.1211, 0.1830), (0.186, 0.1830)),
                    ((0.4681, 0.0854), (0.5330, 0.0854)),
                    ((0.8138, 0.1830), (0.8787, 0.1830)),
                    ((0.8463, 0.4930), (0.9112, 0.4930))),
