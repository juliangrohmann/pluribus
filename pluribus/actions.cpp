...
BlueprintActionProfile::BlueprintActionProfile() {
  set_actions({Action::FOLD, Action::CHECK_CALL, Action{0.80f}, Action::ALL_IN}, 0, 1);
  set_actions({Action::FOLD, Action::CHECK_CALL, Action{0.80f}, Action{1.00f}, Action{1.20f}, Action::ALL_IN}, 0, 2);
  set_actions({Action::FOLD, Action::CHECK_CALL, Action{0.60f}, Action{0.80f}, Action{1.00f}, Action::ALL_IN}, 0, 3);

  set_actions({Action::CHECK_CALL, Action{0.33f}, Action{0.67f}, Action{1.00f}, Action::ALL_IN}, 1, 0);
  set_actions({Action::FOLD, Action::CHECK_CALL, Action{1.00f}, Action::ALL_IN}, 1, 1);
