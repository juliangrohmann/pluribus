...
WPTGoldRingBlueprintProfile::WPTGoldRingBlueprintProfile(const int n_players) {
  ...
  set_iso_actions({Action::FOLD, Action::CHECK_CALL, Action{0.70f}, Action::ALL_IN});
  ...
  // flop
  set_actions({Action::CHECK_CALL, Action{0.33f}, Action{0.50f}, Action{0.75f}, Action::ALL_IN}, 1, 0, 0);
